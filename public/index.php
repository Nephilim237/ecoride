...
// Creation des Routes
    $router
        ...
        ->get('/carpool/my-carpools', 'CarpoolManagerController@my_carpools')
        ->get('/carpool/start', 'CarpoolManagerController@start_carpools')
        ->get('/carpool/end', 'CarpoolManagerController@end_carpools')
